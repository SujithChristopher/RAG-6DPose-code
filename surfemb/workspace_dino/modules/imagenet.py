...
class convnext(nn.Module):
    def __init__(self):
        ...
        pretrained_cfg['file'] = "/home/model_pth/convnext_tiny_22k_224.pth"
        self.model = create_model(model_name,pretrained=True, pretrained_cfg=pretrained_cfg,features_only=True)

        self.transposed_conv = nn.ConvTranspose2d(384, 384, kernel_size=2, stride=2)
    ...
    def forward(self,x):
        ...
        feat = self.transposed_conv(feat)
        # out = feat[2]
        return feat
...
class convnext_base(nn.Module): #torch.Size([512, 14, 14])
    def __init__(self):
        ...
        pretrained_cfg = create_model(model_name).default_cfg
        pretrained_cfg['file'] = "/home/model_pth/convnext_base_22k_224.pth"
        self.model = create_model(model_name,pretrained=True, pretrained_cfg=pretrained_cfg,features_only=True)
...
class convnext_large(nn.Module): #torch.Size([768, 14, 14])
    def __init__(self):
        ...
        pretrained_cfg = create_model(model_name).default_cfg
        pretrained_cfg['file'] = "/home/model_pth/convnext_large_22k_224.pth"
        self.model = create_model(model_name,pretrained=True, pretrained_cfg=pretrained_cfg,features_only=True)
...
class convnextv2_base(nn.Module): #torch.Size([768, 14, 14])
    def __init__(self):
        super(convnextv2_base,self).__init__()
        model_name = "convnextv2_base"
        
        pretrained_cfg = create_model(model_name).default_cfg
        pretrained_cfg['file'] = "/home/surfemb/convnextv2_base_1k_224_fcmae.pt"
        self.model = create_model(model_name,pretrained=True, pretrained_cfg=pretrained_cfg,features_only=True)
...
class ResEncoder(nn.Module):
    def __init__(self):
        ...
        self.backbone = resnext101_32x8d(in_channels=3, pretrained=True, progress=True)
...
if __name__=='__main__':
    a=torch.rand(16,3,224,224).to("cuda:0")
    # model=convnext()
    model=ResEncoder()
    model.to("cuda:0")
    b=model(a)
    ...
    # torch.Size([10, 64, 80, 256])
    # torch.Size([10, 64, 40, 128])
    # torch.Size([10, 128, 20, 64])
    # torch.Size([10, 256, 10, 32])
    # torch.Size([10, 512, 5, 16])
    # torch.Size([10, 512, 1, 1])
    
# large
# torch.Size([16, 192, 56, 56])
# torch.Size([16, 384, 28, 28])
